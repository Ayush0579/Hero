class Boxes1{
    constructor(){
        this.body = Bodies.rectangle(300,-25,50,50);
        this.body1 = Bodies.rectangle(300,-75,50,50);
        this.body2 = Bodies.rectangle(300,-125,50,50);
        this.body3 = Bodies.rectangle(300,-175,50,50);
        this.body4 = Bodies.rectangle(300,-225,50,50);
        this.body5 = Bodies.rectangle(300,-275,50,50);
        this.body6 = Bodies.rectangle(300,-325,50,50);
