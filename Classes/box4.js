class Boxes4{
    constructor(){
        this.body = Bodies.rectangle(600,-25,50,50);
        this.body1 = Bodies.rectangle(600,-75,50,50);
        this.body2 = Bodies.rectangle(600,-125,50,50);
        this.body3 = Bodies.rectangle(600,-175,50,50);
        this.body4 = Bodies.rectangle(600,-225,50,50);
        this.body5 = Bodies.rectangle(600,-275,50,50);
        this.body6 = Bodies.rectangle(600,-325,50,50);
