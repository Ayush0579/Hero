class Boxes2{
    constructor(){
        this.body = Bodies.rectangle(400,-25,50,50);
        this.body1 = Bodies.rectangle(400,-75,50,50);
        this.body2 = Bodies.rectangle(400,-125,50,50);
        this.body3 = Bodies.rectangle(400,-175,50,50);
        this.body4 = Bodies.rectangle(400,-225,50,50);
        this.body5 = Bodies.rectangle(400,-275,50,50);
        this.body6 = Bodies.rectangle(400,-325,50,50);
